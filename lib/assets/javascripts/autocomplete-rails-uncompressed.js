...
(function(jQuery)
{
  ...
  jQuery.fn.railsAutocomplete = function() {
    var emptyHandler = false;
    if(typeof arguments[0] == 'function')
      emptyHandler = arguments[0];
    return this.live('focus',function() {
      if (!this.railsAutoCompleter) {
        this.railsAutoCompleter = new jQuery.railsAutocomplete(this,emptyHandler);
      }
    });
  };

  jQuery.railsAutocomplete = function (e,handler) {
    _e = e;
    this.init(_e,handler);
  };
  ...
  jQuery.railsAutocomplete.fn.extend({
    init: function(e,handler) {
      e.delimiter = jQuery(e).attr('data-delimiter') || null;
      if(handler)
        e.handleEmptyResponse = handler
      else
        e.handleEmptyResponse = function() {
          return false;
        }
      function split( val ) {
      ...
      jQuery(e).autocomplete({
        ...
        source: function( request, response ) {
          jQuery.getJSON( jQuery(e).attr('data-autocomplete'), {
            ...
            if(jQuery.isEmptyObject(arguments[0]))
              return e.handleEmptyResponse()
